    ...
    var redWins = "!<br/><button class=\"btn b1\" id=\"button\" onClick=\"start()\">Play Next Round \(ENTER\)</button>"
    var blueWins = "!<br/><button class=\"btn b2\" id=\"button\" onClick=\"start()\">Play Next Round \(ENTER\)</button>"
    ...
    function collision() {
        for (var i = 0; i < 20; i++) {
            ...
            if ((s2.x + 10) >= b1[i].x && b1[i].x >= (s2.x - 10) && (s2.y + 10) >= b1[i].y && b1[i].y >= (s2.y - 10)) {
                ...
                score1++;
                setBackground("#FF3239");
                writeMain("Red Wins Round " + (score1 + score2) + redWins)
                dead2 = true;
                s2.x = 10000;
                s2.y = 10000;
                s2.xspeed = 0;
            ...
            if ((s1.x + 10) >= b2[i].x && b2[i].x >= (s1.x - 10) && (s1.y + 10) >= b2[i].y && b2[i].y >= (s1.y - 10)) {
                ...
                score2++;
                setBackground("#57DEE5");
                writeMain("Blue Wins Round " + (score1 + score2) + blueWins);
                dead1 = true;
                s1.x = 10000;
                s1.y = 10000;
                s1.xspeed = 0;
